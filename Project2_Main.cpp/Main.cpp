...
/*  The system should keep track of two lists: (1) Books to be circulated: these are
...
The system should keep track of employees: these are the employees that will get
the books later on

Circulate a book to the employees in the system. The circulation starts on a given
